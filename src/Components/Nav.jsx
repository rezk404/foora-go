            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div className="profileContainer d-flex ms-auto order-5 mx-5">
                    ...
                    <div className="dropdown p-2">
                        ...
                        >
                            <li>
                                <Link to="/profile" className="dropdown-item profLink m-0" ><i className='bx bxs-user mx-1'></i> My profile</Link>
                            </li>
                            <li>
                            </li>
                            <li className='p-0 m-0'>
                                <Link to="/user-setting" className='p-0 m-0'><button className="dropdown-item profLink m-0 " ><i className='bx bxs-cog mx-1' ></i>Settings</button></Link>
                            </li>
                            <li>
                                <button className="dropdown-item" onClick={handleLogout}><i className='bx bx-log-out mx-1'></i>Logout</button>
                            </li>
                        </ul>
                    </div>
                </div>
