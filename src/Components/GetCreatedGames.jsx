...
const GetCreatedGames = () => {
    ...
    const fetchGameData = async (gameId) => {
        try {
            ...
            const response = await axios.get(url, {
                ...
                localStorage.setItem("gamePrice", res.data.data.price)
                localStorage.setItem("venue_name", res.data.data.venue_name)
                localStorage.setItem("playersNumber", res.data.data.players_number)
                ...
                localStorage.setItem("gameLocation", res.data.data.location)
    ...
    useEffect(() => {
        ...
        const initialLocalStorageData = {
            ...
            phone: localStorage.getItem('phone') || '',
            gameLocation: localStorage.getItem('gameLocation') || '',
            playersNumber: localStorage.getItem('playersNumber') || '',
            gamePrice: localStorage.getItem('gamePrice') || '',
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-group text-center">
                                                        ...
                                                        <input type="text" name="name"
                                                            value={formik.values.name || localStorageData.venue_name}
                                                            id="name" onChange={formik.handleChange} className="form-control" placeholder="name" />
